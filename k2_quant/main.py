#!/usr/bin/env python3
"""
K2 QUANT - Main Application (page-driven)
...
def setup_global_styling(app):
    ...
    app.setStyleSheet(
        ...
        * { border-radius: 0px; }
        ...
        QMessageBox { background-color: #0a0a0a; color: #ffffff; border: 1px solid #3a3a3a; border-radius: 0px; min-width: 400px; min-height: 150px; icon-size: 0px; }
        QMessageBox QLabel { color: #ffffff; background-color: transparent; font-size: 14px; padding: 20px; min-height: 40px; }
        QMessageBox QPushButton { background-color: #1a1a1a; color: #ffffff; border: 1px solid #3a3a3a; border-radius: 0px; padding: 10px 30px; font-size: 13px; min-width: 100px; font-weight: normal; }
        QMessageBox QPushButton:hover { background-color: #2a2a2a; border-color: #4a4a4a; }
        QMessageBox QPushButton:pressed { background-color: #3a3a3a; border-color: #5a5a5a; }
        QMessageBox QPushButton:default { background-color: #ffffff; color: #0a0a0a; border: 1px solid #ffffff; }
        QMessageBox QPushButton:default:hover { background-color: #f0f0f0; border-color: #f0f0f0; }
        QMessageBox QPushButton:default:pressed { background-color: #e0e0e0; border-color: #e0e0e0; }
        QMessageBox::icon { image: none; width: 0px; height: 0px; margin: 0px; padding: 0px; border: none; background: none; max-width: 0px; max-height: 0px; min-width: 0px; min-height: 0px; }
        QMessageBox QLabel#qt_msgbox_label { margin: 0px; padding: 20px; }
        QMessageBox QLabel#qt_msgboxex_icon_label { width: 0px; height: 0px; max-width: 0px; max-height: 0px; margin: 0px; padding: 0px; image: none; background: none; border: none; }
        QMessageBox > QWidget > QWidget > QLabel { max-width: 0px; max-height: 0px; width: 0px; height: 0px; image: none; }
        QDialog { background-color: #0a0a0a; border: 1px solid #3a3a3a; }
        """
    )
...
def apply_windows_specific_fixes():
    ...
    if sys.platform == "win32":
        try:
            import ctypes  # placeholder for OS-level tweaks
...
def configure_message_box_defaults():
    ...
    # Intentionally minimal; global stylesheet handles icon suppression
    pass
